            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- Vertical Form -->
                        <form class="row g-3" id="facilityForm" enctype="multipart/form-data">
                            <div class="col-6">
...
<script>
    ...
    async function handleDelete(event) {
        const facilityId = event.target.closest('button').getAttribute('data-id');
    ...
    function handleEdit(event) {
        ...
        alert(`Edit functionality for facility ID: ${facilityId} is not implemented.`);
    }
