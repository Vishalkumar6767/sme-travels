...
<main id="main" class="main">
    ...
    <section class="section">
                    ...
                    <div class="card-body">
                        ...
                        <form class="row g-3" id="featureForm" enctype="multipart/form-data">
                            ...
                            <div class="col-6">
                                ...
                                <input type="file" name="image" class="form-control" required accept="image/jpg, image/jpeg, image/png image/svg" id="imageUpload">
                            </div>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-body" id="featureData">
...
<script>
    ...
    async function loadfeature() {
        try {
            ...
            const facilitiesData = document.querySelector('#featureData');
    ...
    function handleEdit(event) {
        ...
        const featureId = event.target.closest('button').getAttribute('data-id');
    // Redirect to the edit page for the selected feature
    window.location.href = `/sme_Cpanel/edit_feature/${featureId}`; 
    }
